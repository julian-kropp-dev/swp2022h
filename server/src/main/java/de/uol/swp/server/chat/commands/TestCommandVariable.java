...
/** Class for TestCommandVariable. */
public class TestCommandVariable implements Command {
  /**
  ...
  public void execute(
    ...
    chatService.sendToClient(messageContext, chatMessageDTO.getLobbyId(), variable);
  }
}
